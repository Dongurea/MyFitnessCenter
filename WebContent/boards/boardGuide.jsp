...
<div class="carousel-inner" role="listbox">
  <div class="item active">
    <div onclick="location.href='boardGuide.do'"
		style="background-position: center;
		background-repeat: no-repeat;
		background-size: cover;
		width:100%;height:200px; background-image:url(/MFC/boards/images/guide/guide_img2.jpg)">
    <div class="carousel-caption">
      <h3></h3>
    </div>  
   </div>    
 </div></div>
<br><h3 style="width:100%;text-align:center;text-size:120%;font-weight: bold;">가이드 북</h3><hr>
