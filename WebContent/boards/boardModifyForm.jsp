...
<jsp:include page="${part_top_manager}">
 ...
 <form action="boardModifyPro.do" onsubmit="return modifycheck()" enctype="multipart/form-data" method="post"  name="modifyform" >
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <button type="button" class="btn btn-default" onclick="location.href='boardList.do'">취소</button>
    </div>
    <br>
      <div class="col-sm-5">
...
<!-- 기존 게시판 값 input-->
      ...
      <input type="text" class="form-control" name="subject"  placeholder="게시글 제목" value="${boardDto.subject}">
      </div>
      <div class="col-sm-3">
     </div>
     <br><br>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          ...
          <div id="View_area" class="carousel-inner" role="listbox">
            <div class="item active" >
              <img id="imgPart" src="/MFC/boards/images/${boardDto.fileName}" alt="Image">
            </div>
          </div>
		</c:if>
		 <c:if test="${boardDto.fileName==null}">
   ...
   <h5 style="color:white;">   <input name="boardCheck" id="boardCheck" type="radio" value="1" checked> 공지사항
...
&nbsp;<input name="boardCheck" id="boardCheck" type="radio" value="2" checked> 가이드북 </h5> 
      <br><br>
    		  </c:if>
      <hr>
     ...
     <br>
      ...
      <textarea name="content" class="form-control" rows="5" cols="5" id="comment" placeholder="게시글 내용"  >${boardDto.content}</textarea>
