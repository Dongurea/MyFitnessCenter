...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/MFC/specList.do"><img src="/MFC/img/main/mark.png"></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
  	  <c:if test="${param.manager_id != null}">
	      <ul class="nav navbar-nav">
	      	<!-- class="active" 는 현재 활성화 된 페이지를 말함 -->
	      	<c:if test="${msgAll != null}">
	         <li data-toggle="dropdown" ><a href="${projectPage}specList.do">회원관리 <span class="badge">${msgAll}</span></a></li>
			    ...
			    <c:if test="${msgAll == null}">
	        		 <li ><a href="${projectPage}specList.do">회원관리 <span class="badge">${msgAll}</span></a></li>
			     </c:if>
