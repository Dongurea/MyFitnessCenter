...
@Controller
public class WorkoutModifyProHandler implements CommandHandler{
	@Resource( name="workoutDao" )
	WorkoutDao workoutDao;
	@RequestMapping("/workoutModifyPro")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws HandlerException {
		...
		int result=workoutDao.updateWorkout(workoutDto);
		request.setAttribute("result", result);
		request.setAttribute("workout_name", request.getParameter("workout_name"));
		return new ModelAndView("workout/workoutModifyPro");
	}
